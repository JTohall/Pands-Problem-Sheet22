...
# I assume that the count method does not count both upper and lower case letters together so
# I counted them both seperately, then I will add them together for the output number
...
# and lower case E's contained in the text file.
